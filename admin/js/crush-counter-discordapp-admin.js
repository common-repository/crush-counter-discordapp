(function( $ ) {
	 ...
	 */
	 ...
	 $(function(){
         ...
         var frame,
             imgUploadButton = $( '#upload_bot_avatar_button' ),    
             imgContainer = $( '#upload_avatar_preview' ),
             imgIdInput = $( '#bot_avatar_id' ),
             imgPreview = $('#upload_avatar_preview'),        
             imgDelButton = $('#crush-counter-discordapp-delete_logo_button');
        ...
        // wp.media add Image
         imgUploadButton.on( 'click', function( event ){
            ...
            frame = wp.media({
              title: 'Escolha ou envie um arquivo para ser utilizado como Avatar do seu Bot.',
              button: {
                text: 'Use como imagem do Bot'
              },
